...
import com.jozibear247_cab.component.MyFontHistoryTextView;
...
public class HistoryAdapter extends BaseAdapter implements
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		case TYPE_ITEM:
			...
			Log.d("mahi", "history date"+history.getDate());
	...
	private String formatTime(String strDate) {
		...
		Calendar cal = Calendar.getInstance();
		SimpleDateFormat date = new SimpleDateFormat("hh:mm a", Locale.ENGLISH);
